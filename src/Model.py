...
class Model:
 ...
 def __init__(this, vertices: list[Vertex3D], indices: list[list[int]], colours: list[Vertex3D]):
 ...
 def get_colours(this):
  return numpy.array(
   [
    list(colour.get_coordinates()) + [1.0]
 ...
 def from_json(data: dict):
  return Model(
   ...
   data["indices"],
   [Vertex3D.from_json(colour) for colour in data["colours"]]
  )
